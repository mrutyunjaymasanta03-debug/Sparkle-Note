...
import { type Note, useDeleteNote, useToggleNotePin, getListNotesQueryKey, getGetNoteStatsQueryKey, getGetAllTagsQueryKey, getGetRecentNotesQueryKey } from "@workspace/api-client-react";
